  ...
  return (
    <header className="sticky top-0 z-50 border-b border-primary/30 bg-background/85 backdrop-blur-lg">
      <div className="container flex h-16 items-center justify-between px-4 md:px-6 relative overflow-hidden">
        ...
        <Link
          href="/"
          className="flex items-center gap-3 font-bold text-lg md:text-xl mr-6 relative z-10"
        >
          <div className="flex items-center gap-2 rounded-full border border-primary/40 bg-primary/10 px-3 py-1 shadow-[0_0_0_1px_rgba(0,0,0,0.15)]">
            ...
            <span className="uppercase tracking-[0.24em] text-[11px] text-primary">
              Stacks Lab
            </span>
          </div>
          <span className="hidden lg:inline-block text-muted-foreground text-xs tracking-[0.28em]">
            Bitcoin-Native Console
          </span>
        </Link>
        <nav className="flex items-center gap-1 flex-1 overflow-x-auto no-scrollbar relative z-10">
          <Link href="/chat">
            <Button
              ...
              size="sm"
              className="gap-2 px-3 rounded-full"
            >
          ...
          <Link href="/launchpad">
            <Button
              variant={isActive("/launchpad") ? "secondary" : "ghost"}
              size="sm"
              className="gap-2 px-3 rounded-full"
            >
        ...
        <div className="flex items-center gap-3 relative z-10">
          {pathname === "/" && (
            <Button
              variant="outline"
              className="hidden sm:flex rounded-full border-primary/40 hover:bg-primary/10"
              asChild
            >
